...
1. Complete HA setup, services, options, restart and reauth validation.
...
4. Verify fan speed, swing and angle encodings before exposing controls.
5. Add native Eco, Quiet, Turbo/Super, Backlight and 8-degree-heating switches where supported.
6. Add Sleep/swing-angle selects and measurement/error entities only after semantics and units are established.
